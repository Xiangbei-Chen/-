...
setwd("C://Users//41939//Desktop//大创项目文件夹//子痫前期//子痫训练集GSE75010//23.Nomo")      #设置工作目录
...
#构建模型，绘制列线图
lrmModel=lrm(Type~ CST6+SASH1+CCBL1+FSTL3+SPAG4, data=rt, x=T, y=T)
...
dc=decision_curve(Type ~ CST6+SASH1+CCBL1+FSTL3+SPAG4, data=rt, 
